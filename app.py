...
navigation = st.navigation(
    [
        st.Page("pages/01_Overview.py", title="Overview World", icon=":material/public:"),
        st.Page("pages/11_Overview_Rus_World.py", title="Overview Rus & World", icon=":material/language:"),
        ...
        st.Page("pages/10_Russia.py", title="Russia", icon=":material/flag:"),
